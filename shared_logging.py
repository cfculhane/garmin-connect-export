# ------------------------------------------------------------------------------
#  Copyright Kico Knee Innovation (c) 2018. All rights reserved.
#  Last modified 17/12/18 5:13 PM
#  Developed by Chris Culhane - chris@kneesystems.com
# ------------------------------------------------------------------------------
#
# Seperate logging module that can be used by both the SimplewareOverwatch processes and ScanIP
